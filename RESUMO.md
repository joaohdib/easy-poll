# Resumo do MVP — Enquetes no WhatsApp
...
- Botão **Usar membros do grupo**:
  - consulta somente o grupo selecionado;
  - usa os nomes dos primeiros 12 membros como opções;
...
5. Digitar manualmente as opções ou clicar em **Usar membros do grupo**.
...
- `GET /api/groups/:groupId/members` — retorna os nomes dos primeiros 12 membros do grupo.
...
- São usados no máximo 12 membros por causa do limite definido para as opções da enquete.
